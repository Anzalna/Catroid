...
public class MainMenuSteps extends AndroidTestCase {
	...
	public void iPressThePlayButton() {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
		clickOnBottomBar(solo, R.id.button_play);
	}
	//@Deprecated
	...
	public void iInputProgramNameInButton(String view) {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
		if (view.equals(view)) {
	...
	public void I_check_the_brick_category_control() {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
	...
	@And("^I press the (\\w+)$")
	public void iTestTheCategoryCategories(String Category) {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
		switch (Category) {
			case "Categories":
	...
	public void iTakeTheScreenshot() {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
...
/*
	...
	public void iAssignSetvariable(String text) {
		Solo solo = (Solo) Cucumber.get(Cucumber.KEY_SOLO);
