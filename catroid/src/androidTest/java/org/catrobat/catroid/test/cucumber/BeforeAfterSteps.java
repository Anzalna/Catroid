...
public class BeforeAfterSteps extends ActivityInstrumentationTestCase2<MainMenuActivity> {
	...
	public void before() {
		...
		String defaultSceneName = context.getString(org.catrobat.catroid.R.string.default_scene_name);
		String defaultBackgroundName = context.getString(org.catrobat.catroid.R.string.background);
		String defaultProjectName = context.getString(org.catrobat.catroid.R.string.default_project_name);
		String defaultSpriteName = context.getString(R.string.default_drone_project_sprites_down);
		Cucumber.put(Cucumber.KEY_DEFAULT_SCENE_NAME, defaultSceneName);
