...
@CucumberOptions(features = "features/bricks",
       // plugin = { "html:/mnt/sdcard/cucumber-html-report"},
		...
		tags = {"~@ignore"})
		//plugin = { "html:sdcard/cucumber-html-report",
		//		"json:sdcard/cucumber.json", "pretty:sdcard/cucumber/cucumber-pretty.txt",
		//		"usage:sdcard/cucumber-usage.json", "junit:sdcard/cucumber/cucumber-results.xml" }
		//tags = {"~@sanity"}, The scenario which have this type of tags will not be execute.
